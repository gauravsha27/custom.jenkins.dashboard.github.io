    ...
    $('#retrieve-resources').click(function () {
        ...
        $.ajax({
          ...
          success: function(result){
            ...
            $('.lasttimestamp').text(lastModified);

            output="<table class='responsive-table'><thead><tr><th scope='row'>Environment</th><th scope='row'>IP</th><th scope='row'>Branch</th><th scope='row'>Time Stamp</th><th scope='row'>Status</th><th scope='row'>Built By</th><th scope='row'>Job Type</th></thead><tbody>";
